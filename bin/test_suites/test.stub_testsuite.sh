...
skip.test.stub_testsuite.custom_support() {
    local expected=0
    local actual=0
...
#-----------------------------------------------------------------------------------------
# provide brief explanation of what test does
skip.test.stub_testsuite.nameSpace() {
    local expected=0
    local actual=0
#    assert_equals "$expected" "$actual"
    fail 'test not implemented'
...
#-----------------------------------------------------------------------------------------
# provide brief explanation of what test does
skip.test.stub_testsuite.setup() {
    local expected=0
    local actual=0
#    assert_equals "$expected" "$actual"
    fail 'test not implemented'
...
#-----------------------------------------------------------------------------------------
# provide brief explanation of what test does
skip.test.stub_testsuite.setup_suite() {
    local expected=0
    local actual=0
#    assert_equals "$expected" "$actual"
    fail 'test not implemented'
...
#-----------------------------------------------------------------------------------------
# provide brief explanation of what test does
skip.test.stub_testsuite.teardown() {
    local expected=0
    local actual=0
#    assert_equals "$expected" "$actual"
    fail 'test not implemented'
...
#-----------------------------------------------------------------------------------------
# provide brief explanation of what test does
skip.test.stub_testsuite.teardown_suite() {
    local expected=0
    local actual=0
#    assert_equals "$expected" "$actual"
    fail 'test not implemented'
...
#-----------------------------------------------------------------------------------------
# provide brief explanation of what test does
skip.test.stub_testsuite.test_stub() {
    local expected=0
    local actual=0
#    assert_equals "$expected" "$actual"
    fail 'test not implemented'
...
# setup MOCK logger
setup() {
    [ "$test_stub_testsuite_sh_DEBUG" = 0 ] || printf '\x1b[94m%s\x1b[0m\n\n' 'Running setup'
