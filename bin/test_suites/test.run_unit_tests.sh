...
# --------------------------------              -----------------------------------------
# setup_suite()                                 __test_run_unit_tests_sh.mktemp()
# teardown_suite()                              __test_run_unit_tests_sh.mock_logger()
# setup()                                       export test_run_unit_tests_sh_LOG_file 
# teardown()                                    export test_run_unit_tests_sh_UT_TEST_DIR
#                                               export test_run_unit_tests_sh_DEBUG
#                                              
#
...
setup_suite() {
    ...
    test_run_unit_tests_sh_UT_TEST_DIR="$temporaryDir" 
...
teardown_suite() {
    ...
    [ "$test_run_unit_tests_sh_UT_TEST_DIR" ] || return
    [ "$test_run_unit_tests_sh_UT_TEST_DIR" != '/' ] || return
    [ "$test_run_unit_tests_sh_UT_TEST_DIR" != '~' ] || return
    [ "$test_run_unit_tests_sh_UT_TEST_DIR" != "$( cd ~ && pwd )" ] || return
    [ "$test_run_unit_tests_sh_UT_TEST_DIR" != "$TMP" ] || return

    # clean up our junk
    rm -rf "$test_run_unit_tests_sh_UT_TEST_DIR"
}
...
setup() {
    ...
    fake 'term.log' '__test_run_unit_tests_sh.mock_logger $*'
    touch "$test_run_unit_tests_sh_LOG_file" 
}
...
__test_run_unit_tests_sh.mktemp() {
    mktemp --tmpdir="$test_run_unit_tests_sh_UT_TEST_DIR" $* 2>/dev/null
}
export -f __test_run_unit_tests_sh.mktemp

# MOCK logger implementation
__test_run_unit_tests_sh.mock_logger() {
    printf "%s\n" "$FAKE_PARAMS" >> "${test_run_unit_tests_sh_LOG_file}"
}
export -f __test_run_unit_tests_sh.mock_logger

export test_run_unit_tests_sh_LOG_file 
export test_run_unit_tests_sh_UT_TEST_DIR
export test_run_unit_tests_sh_DEBUG=0
