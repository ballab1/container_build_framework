...
#Tests for package.bashlib
export LOG=test_log

function setup() {
  source "$BATS_TEST_DIRNAME/../lib/package.bashlib"
...
@test "package.installTimezone" {
  run package.installTimezone
}

@test "package.updateIndexes" {
  run package.updateIndexes
}
